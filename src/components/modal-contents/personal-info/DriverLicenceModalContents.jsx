...
export default function DriverLicenceModalContents({setCurrentModalContent}) {
    return (
        <div className="w-full max-w-2xl space-y-6 bg-white rounded-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                ...
                <div className="border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-red-500 transition-colors duration-200">
                    ...
                    <p className="text-base font-semibold text-gray-800 mb-1">Upload front</p>
                ...
                <div className="border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-red-500 transition-colors duration-200">
                    ...
                    <p className="text-base font-semibold text-gray-800 mb-1">Upload back</p>
                    <p className="text-sm text-gray-500">JPEG or PNG only</p>
                </div>
            </div>
