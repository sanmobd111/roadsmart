...
export default function AddVehiclePopUpContents() {
...
export function SelectVehiclePopupContents({ setSelectedTab,  }) {
    return (
        <div className="">
            <div className="space-y-4 min-h-[30vh] flex items-center">
...
export function LicensePlatePopupContents({ handleBack, activeTab, setActiveTab, setCurrentModal, setIsModalOpen }) {
    // const [currentModal, setCurrentModal] = useState("review-details");
    // const [isModalOpen, setIsModalOpen] = useState(false);
    const [isLicensePlateValid, setIsLicensePlateValid] = useState(false);
    const [licensePlate, setLicensePlate] = useState("");
    ...
    return (
        <div className="">
            <div className="space-y-4 lg:space-y-6">
                {/* <h1 className="text-2xl font-bold text-gray-900 pb-4 lg:pb-6 border-b border-gray-200">Add a car</h1> */}
                <Tabs defaultValue="license-plate" className="w-full" onValueChange={setActiveTab}>
                    <TabsList className="flex gap-2 bg-transparent h-auto p-0 sm:gap-4">
                        <TabsTrigger
                            value="license-plate"
                            className="text-sm sm:text-base text-gray data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:text-gray-black data-[state=active]:font-semibold rounded-none pb-2 px-1 sm:px-0"
                        >
                            License Plate
                        </TabsTrigger>
                        <TabsTrigger
                    ...
                    <div className="mt-2 lg:mt-4 sm:mt-8 mb-0">
                        <TabsContent value="license-plate" className="lg:space-y-4 mb-0">
                            ...
                            <Button
                                ...
                                className="mt-6 bg-primary hover:bg-primary text-white w-full sm:w-auto px-10 ml-auto block py-3 h-auto text-sm sm:text-base mx-auto"
                                disabled={!isVinValid && !isLicensePlateValid && !isManualFormValid}
                            >
                                Let's Go
                            </Button>
                        ...
                        <TabsContent value="manual" className="space-y-4 lg:w-[90%]">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                {[
                                    { field: "year", label: "YEAR", items: ["2024", "2023", "2022", "2021", "2020"] },
                                    { field: "make", label: "MAKE", items: ["Toyota", "Honda", "Ford", "BMW", "Mercedes"] },
                            ...
                            <Button
                                ...
                                className="mt-6 bg-primary hover:bg-primary text-white sm:w-auto px-10 ml-auto  py-3 h-auto text-sm sm:text-base block w-fit mx-auto"
                                disabled={!isVinValid && !isLicensePlateValid && !isManualFormValid}
                            >
                                Go
                            </Button>
