...
const serviceCategories = [
  {
    ...
    color: "text-red-500",
    services: [
      { name: "Normal Car Wash", featured: true, url: "cleaning/location" },
      { name: "Engine Wash ", url: "cleaning/location" },
      { name: "Full Valet", url: "cleaning/location" },
    ],
  },
  {
    id: "Detailings",
    ...
    color: "text-blue-500",
    services: [
      { name: "Head Light Polishing ", url: "cleaning/location" },
      { name: "Waxing", url: "cleaning/location" },
      { name: "Polishing", url: "cleaning/location" },
    ],
  },
];
