...
export default function Component() {
    ...
    const myRequests = useSelector((state) => state?.myRequests?.myRequests);
            ...
            <div className="w-full h-[70vh] mb-10 flex flex-col max-w-md bg-white rounded-lg">
                <div>
                    ...
                    <div className="mb-6">
                        ...
                        >
                            <BackButton className={"-translate-x-[20vw]"} onclick={handlePrev} />
                    ...
                    <div className="lg:w-[90%] mx-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <button onClick={() => setIsModalOpen(true)} className="w-full px-3 py-2 lg:px-4 lg:py-3 border border-gray-300 rounded-md text-gray-500 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-left">
                                    ...
                                    <>
                                        <div className="bg-[#fef2f24f] rounded-lg py-3 px-4 mb-4">
                                            ...
                                            <div className="flex justify-between text-sm lg:text-lg">
                                                ...
                                                <button className="text-red-500 cursor-pointer " onClick={() => setIsModalOpen(true)}>
                                                    Edit
                                                </button>
                                            </div>
                ...
                <Modal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen}>
                    <AddNoteModalContents note={note} setNote={setNote} setIsModalOpen={setIsModalOpen} />
                </Modal>
            </div >
