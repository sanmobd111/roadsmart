          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-x-20 mb-8">
            ...
            <div>
              ...
              <Input
                id="streetAddress"
                type="text"
                placeholder="iShop ZAMBIA, Unit E"
                className="w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500 h-12"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Select defaultValue="west-sussex">
            ...
            <div>
              ...
              <Input
                id="zipCode"
                type="text"
                placeholder="Burgess Hill" // Assuming this is a placeholder for the zip code
                className="w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500 h-12"
              />
            </div>
            <div>
