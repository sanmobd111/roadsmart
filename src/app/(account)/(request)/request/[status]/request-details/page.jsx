    ...
    return (
        <Container className="">
            <div className="w-full">
                ...
                {
                    status === "accept" && <AcceptedRequestDetails />
                }
                {
                    status === "cancel" && <NotAcceptedRequestDetails />
                }
                <div className=" flex flex-col-reverse lg:flex-row justify-between">
                    <div className="space-y-10 xl:space-y-16 mt-4 md:my-6 xl:my-10 lg:w-[70%]">
                        ...
                        {
                            status !== "request-estimate" || status !== "request-estimate" && <div className="">
                    ...
                    {
                        status === "support" || status === "claim" || status === "accept" || status == "request-estimate" ? <CollapseRequestInfo /> : <div className="mt-20 lg:w-[20%]">
...
function AcceptedRequestDetails() {
    return (
        <div className="space-y-4">
            <div className="bg-transparent border border-primary rounded-lg p-4 flex items-center gap-4 transition-colors cursor-pointer">
                {/* Green checkmark icon */}
                <div className="bg-secondary rounded-2xl p-3 flex-shrink-0">
                    <PiBellRingingThin className="w-6 h-6 text-primary stroke-2" />
                </div>

                {/* Content */}
                <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Your request has been submitted</h3>
                    <p className="text-sm text-gray-600">
                        You will ne notified when your request changes status
                    </p>
                </div>
            </div>
            <div className="bg-transparent border border-primary rounded-lg p-4 flex items-center gap-4 transition-colors cursor-pointer">
...
function NotAcceptedRequestDetails() {
    return (
        <div className=" shadow-sm rounded-2xl p-4 flex items-center gap-4 hover:bg-rose-100 transition-colors cursor-pointer mt-10">
            {/* Pink bell icon */}
            <div className="bg-rose-500 rounded-2xl p-3 flex-shrink-0">
                <Bell className="w-6 h-6 text-white stroke-2" />
            </div>

            {/* Content */}
            <div className="flex-1 min-w-0">
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Request Cancelled</h3>
                <p className="text-sm text-gray-600">
                    Cancelled on Jul 10, 2025 | 10:45 AM. You can{" "}
                    <span className="font-medium text-gray-900">create a new request</span>
                </p>
            </div>
        </div>
    )
...
function ClaimRequestHeader() {
    return (
        <div className=" shadow-sm rounded-2xl p-4 flex items-center gap-4 hover:bg-rose-100 transition-colors cursor-pointer mt-10">
            ...
            {/* Content */}
            <div className="flex-1 min-w-0">
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Estimates Requested </h3>
                <p className="text-sm text-gray-600">
                    Requested on Jul 10, 2025 | 10:45 AM. You can{" "}
                    <span className="font-medium text-gray-900">create a new request</span>
                </p>
            </div>
        </div>
