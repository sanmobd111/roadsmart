...
import EstimateSection from '@/components/account/estimate/EstimateSection';
...
export default function page() {
    return (
        <EstimateSection coverageData={coverageData} insuranceItems={insuranceItems} status={"not-accepted"} />
    )
}
