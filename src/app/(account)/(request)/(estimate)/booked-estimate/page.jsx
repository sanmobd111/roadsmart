    ...
    return (
        <Container className="!mt-4">
            <div className="w-full">
                ...
                <StatusHeader Icon={PiBellRingingThin} title={"Estimate Accepted "} subText={"$500 Estimate Accepted "} hasBtn btnText={"View estimate"} path={"/accept-estimate"} />
                <div className=" flex flex-col-reverse lg:flex-row justify-between">
                    <div className="space-y-10 mt-4 md:mb-6 xl:mb-10 lg:w-[70%]">
                        <div>
                            <h2 className="border-b border-gray-400 font-medium text-xl pb-2 mb-4">Items</h2>
                            {/* <SectionHeading text={"Items"}  /> */}
                            <div className="space-y-4 lg:space-y-8 w-[95%]">
